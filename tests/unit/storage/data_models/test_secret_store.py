...
class TestUserSecrets:
    ...
    def test_model_copy_update_fields(self):
        ...
        updated_provider_tokens = MappingProxyType(
            {ProviderType.GITHUB: github_token, ProviderType.GITLAB: gitlab_token, ProviderType.AZURE_DEVOPS: azure_devops_token}
        )
        ...
        assert (
            updated_store1.provider_tokens[ProviderType.AZURE_DEVOPS].token.get_secret_value()
            == 'azure-devops-token-789'
        )
    ...
    def test_initializing_provider_tokens_with_mixed_value_types(self):
        ...
        mixed_provider_tokens = {
            ...
            ProviderType.AZURE_DEVOPS: provider_tokens_dict[ProviderType.AZURE_DEVOPS],  # Dict
        }
